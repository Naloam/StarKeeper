      ...
      >
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <div className={`${config.bg} rounded-lg p-6 text-center`}>
            <div className={`text-6xl font-bold ${config.color} mb-2`}>{score}</div>
            <div className={`text-xl font-semibold ${config.color}`}>{config.label}</div>
              ...
              <div>
                ...
                <div className="mt-2 text-xs text-text-secondary space-y-1">
                  ...
                  {details.latestRelease && (
                    <div>
                      • 最新版本: {details.latestRelease.tagName} (
                      {formatDate(details.latestRelease.publishedAt)})
                    </div>
                  )}
                </div>
              </div>
